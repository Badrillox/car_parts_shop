...
public class Basket {
    ...
    private PaymentOptions _paymentOption;
    ...
    public boolean removeItem(int id){
        for(BasketItem b : this._items){
            if(id == b.getArticle().getArticleID()){
    ...
    public Basket(){this(null, 0.0, null, null, 0);}
    public Basket(PaymentOptions paymentOptions, double price, Customer customer, Address deliveryAddress, long bestellnummer){
